...
mkdir -p ${WORKSPACE_ROOT}/build/ubuntu24.clang18.Release
...
docker run -it \
  ...
  --mount type=bind,source=${WORKSPACE_ROOT}/build/ubuntu24.clang18.Release,target=/ticket-decoder/build/Release/bin \
  ubuntu24-clang18-ticket-decoder-builder
